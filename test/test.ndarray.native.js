...
var drssbl = tryRequire( resolve( __dirname, './../lib/ndarray.native.js' ) );
var opts = {
...
tape( 'the function calculates the residual sum of squares of two vectors using Blue\'s algorithm', opts, function test( t ) {
	var x;
	var y;
	var z;
